...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="brand">
    ...
    <body class="antialiased bg-base-100 text-base-content">
        ...
        {{-- ── Sticky Navigation (Clay-style mega-menu) ───────────────────── --}}
        <header
            x-data="{ open: false, scrolled: false }"
            @scroll.window="scrolled = window.scrollY > 10"
            :class="scrolled ? 'bg-white/80 backdrop-blur-md shadow-warm-lg' : 'bg-white'"
            class="sticky top-0 z-50 border-b border-neutral-200 transition-all duration-300 bg-white"
        >
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <a href="#testimonials" class="block px-3 py-2 rounded-lg text-neutral-700 hover:bg-primary/10 hover:text-primary font-medium text-sm transition-colors">Reviews</a>
                    <a href="#faq" class="block px-3 py-2 rounded-lg text-neutral-700 hover:bg-primary/10 hover:text-primary font-medium text-sm transition-colors">FAQ</a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-sm opacity-50 leading-relaxed max-w-xs">
                            Solve 100 puzzles. Earn a custom-designed physical medal. Shipped to your door, anywhere in the world.
                        </p>
                        <p class="text-xs opacity-40 leading-relaxed mt-4">
                            Puzzles sourced from the open <a href="https://lichess.org" target="_blank" rel="noopener" class="underline hover:text-brand">Lichess</a> puzzle database.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            ...
                            <li><a href="#how-it-works" class="opacity-70 hover:opacity-100 transition-opacity">How It Works</a></li>
                        </ul>
                    </div>
