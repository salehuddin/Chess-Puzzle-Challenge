...
@php
    ...
    $isChallengeRecordPage = str_starts_with($this::class, 'App\\Filament\\Resources\\Challenges\\Pages\\');
    $tabPageHeading = method_exists($this, 'getTabPageHeading') ? $this->getTabPageHeading() : null;
@endphp
...
>
    ...
    <div class="fi-page-header-main-ctn">
        ...
        @else
            ...
            @if (filled($headerActions) || $breadcrumbs || filled($heading) || filled($subheading))
                <x-filament-panels::header
                    ...
                    :heading="$heading"
                    :subheading="$isChallengeRecordPage ? null : $subheading"
                >
        ...
        <div class="fi-page-main">
            ...
            @if ($isChallengeRecordPage && filled($tabPageHeading))
                <div class="fi-page-challenge-tab-heading-ctn">
                    <h2 class="fi-page-challenge-tab-heading">
                        {{ $tabPageHeading }}
                    </h2>
                </div>
            @endif
