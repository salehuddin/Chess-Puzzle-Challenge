{{--
    Step card content partial.
    Shared between mobile (normal flow) and desktop (absolute positioned + transitioned).
    Receives: $step (array), $i (int, step index)
--}}
@php
    $isReversed = isset($reverse) && $reverse;
@endphp
...
<div class="[direction:ltr] flex flex-col justify-center">
    ...
    <h3 class="font-display text-2xl font-black text-neutral-900 mb-4 leading-tight">{{ $step['title'] }}</h3>
