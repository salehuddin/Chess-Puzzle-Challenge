<div class="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 font-serif">Order Details</h1>
            <p class="text-gray-500 mt-1">Order #{{ $tracking['order_id'] }} - {{ $tracking['challenge_name'] }}</p>
        </div>
    ...
    <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-8">
        ...
        <div class="bg-gray-50 p-6 border-b border-gray-100">
            <h2 class="text-lg font-bold text-gray-800">Tracking Timeline</h2>
        </div>
            ...
            <ul class="steps steps-vertical lg:steps-horizontal w-full">
                ...
                <li class="step step-primary" data-content="{{ $tracking['status'] === 'pending' ? '✉' : '✓' }}">
                    <div class="text-left lg:text-center mt-2">
                        ...
                        <p class="text-xs text-gray-500">{{ $tracking['created_at']?->format('M j, Y') }}</p>
                    </div>
                </li>
                ...
                <li class="step {{ $tracking['status'] === 'shipped' ? 'step-primary' : '' }}" data-content="🚚">
                    <div class="text-left lg:text-center mt-2">
                        ...
                        @if($tracking['shipped_at'])
                            <p class="text-xs text-gray-500">{{ $tracking['shipped_at']->format('M j, Y') }}</p>
                        @endif
                    </div>
                </li>
            </ul>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <!-- Shipping Logistics -->
        <div class="card bg-white shadow-md border border-gray-100">
            <div class="card-body">
                <h3 class="card-title text-gray-800 border-b pb-2">Logistics Info</h3>
                    ...
                    <div class="mt-4 space-y-4">
                        <div>
                            ...
                            <p class="font-bold text-lg text-gray-800">{{ $tracking['courier'] ?: 'Standard Mail' }}</p>
                        </div>
                        <div>
                            <p class="text-sm text-gray-500">Tracking Number</p>
                            <p class="font-mono text-lg bg-gray-100 px-3 py-1 rounded inline-block">{{ $tracking['tracking_number'] ?: 'Untracked' }}</p>
                        </div>
                ...
                @else
                    <div class="mt-4 text-center py-6 opacity-60">
                        ...
                        <h4 class="font-bold text-gray-600">Finish playing first!</h4>
                        <p class="text-gray-500 text-sm mt-2">Complete all puzzles in this challenge to trigger the shipment of your physical rewards.</p>
        ...
        <div class="card bg-white shadow-md border border-gray-100">
            <div class="card-body">
                <h3 class="card-title text-gray-800 border-b pb-2">Shipping Address</h3>
                ...
                @else
                    <div class="mt-4 text-center py-6">
                        <p class="text-gray-500 text-sm">We will use your account's default shipping address when you complete this challenge.</p>
