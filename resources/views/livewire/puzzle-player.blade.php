...
<div class="max-w-5xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
            ...
            <p class="text-neutral-600 mt-1" x-data>
                Puzzle 
    ...
    {{-- Progress Bar --}}
    <div class="w-full bg-neutral-200 rounded-full h-3 mb-8 overflow-hidden shadow-inner">
    ...
    @if(!empty($orderedPuzzleIds))
        <div class="mb-8 bg-white rounded-2xl border border-neutral-100 shadow-sm p-4">
            <div class="flex items-center justify-between mb-3">
                <h3 class="text-sm font-semibold uppercase tracking-wider text-neutral-600">Puzzle Progress Map</h3>
            ...
            <div class="grid grid-cols-10 sm:grid-cols-12 md:grid-cols-15 lg:grid-cols-20 gap-1.5">
                @foreach($orderedPuzzleIds as $index => $puzzleId)
                    ...
                    @endphp
                    <div
                        class="h-4 rounded-sm border {{ $solved ? 'bg-green-500 border-green-600' : ($current ? 'bg-orange-400 border-orange-500' : 'bg-neutral-100 border-neutral-200') }}"
            ...
            <div class="mt-3 flex flex-wrap items-center gap-4 text-xs text-neutral-600">
                ...
                <div class="flex items-center gap-1.5"><span class="inline-block w-3 h-3 rounded-sm bg-neutral-100 border border-neutral-200"></span><span>Remaining</span></div>
            </div>
        </div>
    @endif
    ...
    @else
        ...
        >
                ...
                <div class="aspect-square relative rounded-lg shadow-2xl border-4 border-green-900/10 overflow-hidden bg-white transition-opacity duration-200">
                    ...
                    <div x-show="showSuccess" x-cloak
                        ...
                        <div class="bg-white p-8 rounded-2xl shadow-xl border border-green-100 text-center transform max-w-sm w-full mx-4">
                            ...
                            <h3 class="text-3xl font-bold text-neutral-900 mb-2 font-serif">Excellent!</h3>
                    ...
                    <div x-show="puzzleError" x-cloak
                        ...
                        <div class="bg-white p-8 rounded-2xl shadow-xl border border-red-200 text-center max-w-sm w-full mx-4">
                            ...
                            <h3 class="text-2xl font-bold text-neutral-900 mb-2 font-serif">Puzzle Error</h3>
                    ...
                    <div x-show="showError" x-cloak
                        ...
                        <div class="bg-white p-8 rounded-2xl shadow-xl border border-red-100 text-center transform max-w-sm w-full mx-4">
                            ...
                            <h3 class="text-3xl font-bold text-neutral-900 mb-2 font-serif">Incorrect Move</h3>
            ...
            <div class="w-full lg:w-1/3">
                <div class="card bg-base-100 shadow-xl border border-neutral-100 h-full">
                    <div class="card-body">
                        <h3 class="card-title text-2xl font-serif text-neutral-800 tracking-wide">Your Turn</h3>
                        ...
                        <div x-show="ready && !puzzleError" x-cloak class="mt-4">
                            ...
                            <template x-if="lastOpponentMove">
                                <div class="mt-8 p-4 bg-neutral-50 rounded-lg border border-neutral-100">
                                    ...
                                    <div class="mt-2 font-mono text-2xl font-bold text-neutral-800 pl-6" x-text="lastOpponentMove"></div>
                                </div>
                            </template>
